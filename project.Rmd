...
header-includes:
- \usepackage{fancyhdr}
- \fancypagestyle{copyright}{\fancyhf{}\renewcommand{\headrulewidth}{0pt}\cfoot{\copyright \, 2022}}
- \pagestyle{fancy}
- \usepackage{titling}
...
\begin{equation}
f(x) = \frac{\alpha \gamma \lambda ^ \alpha x^{\gamma - 1}}{(\lambda + x ^ \gamma)^{\alpha + 1}}, \; \text{for} \; \alpha, \lambda, \gamma, x > 0
\end{equation}
